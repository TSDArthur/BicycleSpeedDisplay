static public class Config
{
    ...
    static public boolean APP_DEBUG_MODE = false;
    static public boolean APP_SHOW_STREAM = false;
    static public int APP_ANIMATION_FPS = 60;
    static public String APP_COPYRIGHT_STR = "[v" + APP_VERSION + "]";
